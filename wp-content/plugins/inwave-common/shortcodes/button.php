        ...
        function init_params() {
            return array(
                ...
                'params' => array(
                    ...
                    array(
                        "type" => "dropdown",
                        "heading" => __("Background Opacity", "inwavethemes"),
                        "param_name" => "background_opacity",
                        "value" => array(
                            'Yes' => 'background-opacity',
                            'No' => ''
                        )
                    ),
                    array(
...
//                    ),
        ...
        function init_shortcode($atts, $content = null){
            ...
            $output = $class = $button_link = $button_text = $font_weight = $align = $css = $background_color = $background_opacity = $background_color_custom = $text_color = $text_color_custom = $border_color = $border_color_custom = $button_size = $shape = $button_width = $icon = $icon_size =
...
//                'icon_size' => '36',
            ...
            return self::inwave_button_shortcode_html($button_link,$button_text,$font_weight,$align,$css,$background_color,$background_opacity,$background_color_custom,$text_color,$text_color_custom,$border_color,$border_color_custom,$button_size,$style,$shape,$button_width,$icon,$icon_size,$background_color_hover,$text_color_hover,$border_color_hover,$button_effect,$class);
        }
...
//            }
            switch($style){
                ...
                case 'button3':
                    ...
                    $output .= '<a style="'.$extracss.'" class="button-text '.$classcss_button.'" href="'.$button_link.'">'.$button_text.'</a>';
                    $output .= '</div>';
