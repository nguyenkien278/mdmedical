    ...
    $.Gallery.prototype = {
        ...
        _layout: function () {
            ...
            if (this.support3d && this.supportTrans) {
                ...
                leftCSS = {
                    '-webkit-transform': 'translateX(-84%) scale(1) translateY(25%)',
                    '-moz-transform':  'translateX(-84%) scale(1) translateY(25%)',
                    '-o-transform':  'translateX(-84%) scale(1) translateY(25%)',
                    '-ms-transform':  'translateX(-84%) scale(1) translateY(25%)',
                    'transform':  'translateX(-84%) scale(1) translateY(25%)'
                };

                rightCSS = {
                    '-webkit-transform': 'translate(84%) scale(1) translateY(25%)',
                    '-moz-transform': 'translate(84%) scale(1) translateY(25%)',
                    '-o-transform': 'translate(84%) scale(1) translateY(25%)',
                    '-ms-transform': 'translate(84%) scale(1) translateY(25%)',
                    'transform': 'translate(84%) scale(1) translateY(25%)'
                };
