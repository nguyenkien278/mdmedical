	...
	foreach( $shortcodes as $shortcode ) {
		$params = array(
			array(
				'type'        => 'dropdown',
				'class'       => '',
				'heading'     => __( 'Product Filter - Activate', 'prdctfltr' ),
			...
			array(
				'type'        => 'dropdown',
				'class'       => '',
				'heading'     => __( 'Product Filter - Ajax', 'prdctfltr' ),
				'param_name'  => 'ajax',
				'value'       => array(
					'yes',
					'no',
			...
			array(
				'type'        => 'dropdown',
				'class'       => '',
				'heading'     => __( 'Product Filter - Select Preset', 'prdctfltr' ),
				'param_name'  => 'preset',
				'value'       => $presets,
				'description' => '',
				'std'         => ''
