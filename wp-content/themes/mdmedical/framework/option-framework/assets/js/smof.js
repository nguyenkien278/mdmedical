...
jQuery(document).ready(function($){
    ...
    $('#section-demo_data .button-primary').click(function(e){
        ...
        if(confirm('Are you sure you want to import?')){
            $('#section-demo_data .button-primary').html('Importing ...');
            ...
            data.iw_data_type = new Array();
            data.iw_post_type = new Array();
			$('.iw-loading-state').width(0);
            $('.iw-data-option .data-type:checked').each(function(){
                data.iw_data_type.push(this.name.replace(/data-type-/,''));
            });
            $('.iw-data-option .post-type:checked').each(function(){
                data.iw_post_type.push(this.name.replace(/post-type-/,''));
            });
            if(data.iw_data_type.length || data.iw_post_type.length){
