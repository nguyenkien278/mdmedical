...
if( !function_exists( 'inwave_setup' ) ) {
    ...
    */
    function inwave_setup() {
         ...
         * If you're building a theme based on inevent, use a find and replace
         * to change 'mdmedical' to the name of your theme in all the template files
         */
        load_theme_textdomain('mdmedical', get_template_directory() . '/languages');
