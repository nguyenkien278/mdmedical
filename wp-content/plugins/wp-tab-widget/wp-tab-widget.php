...
if ( !class_exists('wpt_widget') ) {
	class wpt_widget extends WP_Widget {
	    ...
	    function wpt_init() {
	        ...
	        add_image_size( 'wp_review_small', 85, 85, true ); // small thumb
		...
		function widget( $args, $instance ) {	
	        ...
	        $available_tabs = array('popular' => __('Tin nổi bật', 'wp-tab-widget'), 
	            'recent' => __('Tin mới nhất', 'wp-tab-widget'), 
	                                    ...
	                                    <a title="<?php the_title(); ?>" href="<?php the_permalink() ?>">		
	    									<?php if(has_post_thumbnail()): ?>	
	    										<?php 
													...
													$img_src = inwave_resize($img_src, 85, 85, true);
												?>		
												<img class="wp-post-image" src="<?php echo $img_src; ?>" alt="<?php the_title(); ?>" />
	    									<?php else: ?>							
