...
<div class="panel-tools">
	<div class="panel-content">
		<div class="row-setting layout-setting">
			<h3 class="title"><?php esc_html_e('LAYOUT', 'mdmedical');?></h3>
			<div class="setting">
				<button value="wide" class="button-command button-command-layout wide <?php if($layout=='wide') echo 'active' ?>"><?php esc_html_e('WIDE', 'mdmedical');?></button>
				<button value="boxed" class="button-command button-command-layout boxed <?php if($layout=='boxed') echo 'active' ?>"><?php esc_html_e('BOXED', 'mdmedical');?></button>
			</div>
		</div>
		<div class="row-setting color-setting sample-setting">
			<h3 class="title"><?php esc_html_e('SAMPLE COLOR', 'mdmedical');?></h3>
			<div class="setting">
				<?php
			...
			<div class="description">
				<?php esc_html_e('Please read our documentation file to know how to change colors as you want', 'mdmedical');?>
			</div>
		</div>
		<div class="overlay-setting <?php if($layout=='wide') echo 'disabled' ?>">
		<div class="row-setting color-setting background-setting">
			<h3 class="title"><?php esc_html_e('BACKGROUND COLOR', 'mdmedical');?></h3>
			<div class="setting">
				<?php
		...
		<div class="row-setting color-setting background-setting">
			<h3 class="title"><?php esc_html_e('BACKGROUND TEXTURE', 'mdmedical');?></h3>
			<div class="setting">
				<div class="setting">
					<?php
        ...
        <?php if(class_exists('RTLTester')): ?>
			<div class="row-setting rtl-setting">
				<div class="setting">
                    <a href="?d=ltr"><span data-value="ltr" class="button-command <?php if(!is_rtl()) echo 'active'; ?>"><?php esc_html_e('LEFT TO RIGHT', 'mdmedical');?></span></a>
					<a href="?d=rtl"><span data-value="rtl" class="button-command <?php if(is_rtl()) echo 'active'; ?>"><?php esc_html_e('RIGHT TO LEFT', 'mdmedical');?></span></a>
