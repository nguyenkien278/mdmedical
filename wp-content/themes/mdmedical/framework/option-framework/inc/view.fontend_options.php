<div class="wrap" id="of_container">
	...
	<div id="of-popup-save" class="of-save-popup">
		<div class="of-save-save"><?php esc_html_e('Options Updated', 'mdmedical'); ?></div>
	</div>
	
	<div id="of-popup-reset" class="of-save-popup">
		<div class="of-save-reset"><?php esc_html_e('Options Reset', 'mdmedical'); ?></div>
	</div>
	
	<div id="of-popup-fail" class="of-save-popup">
		<div class="of-save-fail"><?php esc_html_e('Error!', 'mdmedical'); ?></div>
	</div>
	...
	<form id="of_form" method="post" action="<?php echo esc_url( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="info_bar">
			...
			<img src="<?php echo esc_url(INWAVE_OF_DIR); ?>assets/images/loading.gif" class="hide ajax-loading-img ajax-loading-img-bottom" alt="<?php echo esc_html__('Working...', 'mdmedical'); ?>" />

			<button id="of_save" type="button" class="button-primary">
				<?php esc_html_e('Save Change','mdmedical');?>
			</button>
		...
		<div id="main">
			...
			<div id="content">
                ...
                <?php if(isset($_REQUEST['imported'])){
                    ?>
                    <h2 id="import-notice"><?php echo esc_html__('Imported successfully!', 'mdmedical');?></h2>
                    <?php
                }?>
		  	</div>
