...
if(!function_exists('inwave_plugins_load')){
    ...
    function inwave_plugins_load() {
        ...
        $plugins = array(
            ...
            array(
                'name'               => esc_html__('Visual Composer', 'mdmedical'),
                'slug'               => 'js_composer',
            ...
            array(
                'name'               => esc_html__('Revolution Slider', 'mdmedical'),
                'slug'               => 'revslider',
            ...
            array(
                'name'      => esc_html__('Woocommerce', 'mdmedical'),
                'slug'      => 'woocommerce',
                'required'  => false,
            ),
            array(
                'name'      => esc_html__('YITH Woocommerce Wishlist', 'mdmedical'),
                'slug'      => 'yith-woocommerce-wishlist',
                'required'  => false,
            ),
            array(
                'name'               => esc_html__('InTravel Tour', 'mdmedical'),
                'slug'               => 'mdmedical',
                'source'             => get_template_directory() . '/framework/plugins/intravel.zip',
                'required'           => true,
                'version'            => '1.2.4',
                'force_activation'   => false,
                'force_deactivation' => false,
            ...
            array(
                'name'               => esc_html__('InWave Common', 'mdmedical'),
                'slug'               => 'inwave-common',
